...
JNIEXPORT jboolean JNICALL Java_com_hyunju_jin_movie_camera_IFaceSwapper_loadPoseModel(JNIEnv * jenv, jclass, jstring path)
{
...
JNIEXPORT void JNICALL Java_com_hyunju_jin_movie_camera_IFaceSwapper_swapFaces(JNIEnv * jenv, jclass, jlong frame, jlong faces)
{
