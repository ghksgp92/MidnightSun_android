...
JNIEXPORT jboolean JNICALL Java_com_hyunju_jin_movie_camera_IFaceSwapper_loadPoseModel(JNIEnv *, jclass, jstring);

JNIEXPORT void JNICALL Java_com_hyunju_jin_movie_camera_IFaceSwapper_swapFaces(JNIEnv *, jclass, jlong, jlong);
