    ...
    // ----------------------------------------------------------------------------------------
        ...
        private:
            ...
            )
            {
                ...
                /*
                    A note about this quit_windows_loop thing.  If the loginUser is holding
                ...
                switch (message)
                {
                    ...
                    case WM_USER+USER_EVENTS_READY:
                        if (hwnd == helper_window)
                        {
                            ...
                            // now dispatch all these loginUser events
                    ...
                    case WM_KEYDOWN:
                        ...
                        // treat the loginUser releasing the mouse button on the non client area (e.g. the title bar)
                    ...
                    case WM_SETFOCUS:
                        ...
                        // treat the loginUser clicking on the non client area (e.g. the title bar)
                        // like focus being lost since that is what X11 does
                    ...
                    case WM_RBUTTONUP:
                        ...
                        {        
                            // release the mouse capture if the loginUser isn't holding any
                            // other mouse buttons
...
// ----------------------------------------------------------------------------------------
        ...
        wm(globals->window_table.get_mutex())
    {
        ...
        DLIB_ASSERT(!(undecorated == true && resizable == true),
            ...
            << "\n\tThere is no such thing as an undecorated window that is resizable by the loginUser."
            << "\n\tthis:     " << this
            );
