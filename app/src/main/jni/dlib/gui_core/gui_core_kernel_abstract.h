        ...
        /*!
            ...
            ensures
                ...
                - if (resizable == true) then 
                    - this window will be resizable by the loginUser
                - else 
                    - this window will not be resizable by the loginUser
                - if (undecorated == true) then
    ...
    protected:
        ...
        /*!
            requires
                - is_closed() == false
                - mutex wm is locked
                - is called when the loginUser attempts to close this window
                ...
                - else
                    - this window will not be closed and the attempt to close it
                      by the loginUser will have no effect.
                    - #is_closed() == false
            ensures
        ...
        /*!
            requires
                - is_closed() == false
                - mutex wm is locked
                - is called when the loginUser depresses one of the mouse buttons
        ...
        /*!
            requires
                - is_closed() == false
                - mutex wm is locked
                - is called when the loginUser releases one of the mouse buttons
        ...
        /*!
            requires
                - is_closed() == false
                - mutex wm is locked
                - is called when the loginUser moves the mouse
                - state == the bitwise OR of the buttons that are currently depressed
                  (from the mouse_state_masks enum)
                - (x,y) == the position of the mouse (relative to the upper left corner
                  of the window) when this event occurred. 
                - if (the loginUser is holding down one or more of the mouse buttons) then
                    - the mouse move events will continue to track the mouse even if
                      it goes out of the window.  This will continue until the loginUser
