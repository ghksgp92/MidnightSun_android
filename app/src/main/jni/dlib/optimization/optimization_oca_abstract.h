        ...
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                OCA solves optimization problems with the following form:
                    ...
                    Where R(w) is a loginUser-supplied convex function and C > 0.  Optionally,
                ...
                Or it can alternatively solve:
                    ...
                    Where prior is a loginUser supplied vector and R(w) has the same
                ...
                Note that the stopping condition must be provided by the loginUser
