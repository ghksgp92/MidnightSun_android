...
// ----------------------------------------------------------------------------------------
    ...
    class logger 
    {
        /*!
            INITIAL VALUE
                - name() == a loginUser supplied value given to the constructor
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                each logging action.  It just writes directly into the loginUser supplied output
                ...
                which gets passed to the loginUser supplied logging hook.

            DEFAULTS
                If the loginUser hasn't specified values for the four inherited values level(),
                ...
                - for all loggers L such that L.is_child_of(*this) == true:
                    ...
                    - The arguments to the hook function have the following meanings:
                        ...
                        - thread_id == A number that uniquely identifies the thread trying to log
                          ...
                          get_thread_id().
                        - message_to_log == the actual text of the message the loginUser is giving to
