...
namespace dlib
{
    ...
    /*!
        ...
        EVENT HANDLERS
            Note that all event handlers, including the loginUser registered callback
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ...
        ensures
            - Displays a window titled "Open File" that will allow the loginUser to select a
              file.  
            - The displayed window will start out showing the directory get_current_dir()
              (i.e. it starts in the current working directory)
            - The event_handler function is called on object if the loginUser selects
              a file.  If the loginUser closes the window without selecting a file
              then nothing occurs.
    !*/
    ...
    /*!
        ensures
            ...
            - The displayed window will start out showing the directory get_current_dir()
              (i.e. it starts in the current working directory)
            - The event_handler function is called if the loginUser selects
              a file.  If the loginUser closes the window without selecting a file
              then nothing occurs.
    !*/
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        requires
            - event_handler == a valid pointer to a member function of object T.
        ensures
            - Displays a window titled "Open File" that will allow the loginUser to select
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        requires
            - event_handler == a valid pointer to a member function of object T.
        ensures
            - Displays a window titled "Save File" that will allow the loginUser to select
              a file.  
            - The displayed window will start out showing the directory get_current_dir()
              (i.e. it starts in the current working directory)
            - The event_handler function is called on object if the loginUser selects
...
// ----------------------------------------------------------------------------------------
    ...
    /*!
        ensures
            - displays a message box with the given title and message.  It will have a 
              single button and when the loginUser clicks it the message box will go away.
    ...
    /*!
        ensures
            - displays a message box with the given title and message.  It will have a 
              single button and when the loginUser clicks it the message box will go away.
            - this function blocks until the loginUser clicks on the message box and
    ...
    /*!
        ...
        ensures
            - Displays a message box with the given title and message.  It will have a 
              single button and when the loginUser clicks it the message box will go away.
            - The event_handler function is called on object when the loginUser clicks
    ...
    /*!
        ensures
            - Displays a message box with the given title and message.  It will have a 
              single button and when the loginUser clicks it the message box will go away.
            - The event_handler function is called when the loginUser clicks
              ok or otherwise closes the message box window. 
            - this function does not block but instead returns immediately.
    !*/
...
// ----------------------------------------------------------------------------------------
    ...
    class toggle_button : public button_action 
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                in the checked or unchecked state and when a loginUser clicks on it it toggles its
                state.

                When this object is disabled it means it will not respond to loginUser clicks.
        !*/
    ...
    public:
        ...
        /*!
            ...
            ensures
                - the event_handler function is called on object when the toggle_button is 
                  toggled by the loginUser. self will be a reference to the toggle_button object
                  that the loginUser clicked.
                - this event is NOT triggered by calling set_checked() or set_unchecked().
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
        ...
        /*!
            ensures
                - Returns true if this txt field has input keyboard focus.  If this
                  is the case then it means that when the loginUser types on the keyboard
        ...
        /*!
            ...
            ensures
                - the event_handler function is called on object when the text
                  in this text_field is modified by the loginUser.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ...
            ensures
                - the event_handler function is called on object when this text field
                  has input focus and the loginUser hits the enter key on their keyboard.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ensures
                - the event_handler function is called when this text field has input 
                  focus and the loginUser hits the enter key on their keyboard.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ...
            ensures
                - the event_handler function is called on object when this object
                  loses input focus due to the loginUser clicking outside the text field
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ensures
                - the event_handler function is called when this object loses input 
                  focus due to the loginUser clicking outside the text field
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        /*!
            ...
            ensures
                - the event_handler function is called on object when the text
                  in this text_box is modified by the loginUser.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ...
            ensures
                - the event_handler function is called on object when this object
                  loses input focus due to the loginUser clicking outside the text box
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ensures
                - the event_handler function is called when this object loses input 
                  focus due to the loginUser clicking outside the text box
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
...
// ----------------------------------------------------------------------------------------
    ...
    class tabbed_display : public drawable
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                This object represents a row of tabs that are loginUser selectable.
    ...
    public:
        ...
        /*!
            ensures
                - The event_handler function is called when the loginUser clicks on a tab
...
// ----------------------------------------------------------------------------------------
                     ...
                     public enumerable<const std::string>
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                vertical list of strings which the loginUser may select from.
        !*/
    ...
    public:
        ...
        /*!
            ensures
                - if (this object will allow the loginUser to select more than one item at a time) then
                    - returns true
                - else
                    - returns false
        !*/
        ...
        /*!
            requires
                - event_handler is a valid pointer to a member function in T.
            ensures
                - The event_handler function is called on object when the loginUser double
                  clicks on one of the rows in this list box.  index gives the row 
                  number for the item the loginUser clicked.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ensures
                - The event_handler function is called when the loginUser double clicks on
                  one of the rows in this list box.  index gives the row number for 
                  the item the loginUser clicked.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            requires
                - event_handler is a valid pointer to a member function in T.
            ensures
                - The event_handler function is called on object when the loginUser
                  clicks on one of the rows in this list box.  index gives the row 
                  number for the item the loginUser clicked.  (Note that the second click
        ...
        /*!
            ensures
                - The event_handler function is called when the loginUser clicks on one
                  of the rows in this list box.  index gives the row number for the 
                  item the loginUser clicked.  (Note that the second click in a double
...
// ----------------------------------------------------------------------------------------
    ...
    class directed_graph_drawer : public zoomable_region 
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                This object represents a graphical widget that allows the loginUser to draw
                a directed graph.  
                
                The loginUser can create nodes by right clicking on the draw area and add
    ...
    public:
        ...
        /*!
            requires
                - event_handler is a valid pointer to a member function in T 
            ensures
                - the event_handler function is called on object when the loginUser selects
                  a node.  
        ...
        /*!
            ensures
                - the event_handler function is called when the loginUser selects
                  a node.  
                - node_index == the index of the node that was selected
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
        ...
        /*!
            ensures
                - the event_handler function is called when the loginUser deselects a node.
                - node_index == the index of the node that was deselected
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
        ...
        /*!
            ensures
                - the event_handler function is called when the loginUser deletes a node.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ...
            ensures
                ...
                - the event_handler function is not called when the loginUser just
                  moves nodes around on the screen.
                - This event is always dispatched before any more specific event
                  that results from the loginUser modifying the graph.
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
                  event at a time)
            throws
        ...
        /*!
            ensures
                - the event_handler function is called when the loginUser modifies
    ...
    public:
        ...
        /*!
            requires
                ...
                - col < number_of_columns()
            ensures
                - if (the given grid location is editable by the loginUser) then
                    - returns true
                - else
                    - returns false
        !*/
        ...
        /*!
            ensures
                - the event_handler function is called when the loginUser selects a node.
                - row == row will give the row of the grid item that was modified
                - col == col will give the column of the grid item that was modified
                - any previous calls to this function are overridden by this new call.  
                  (i.e. you can only have one event handler associated with this 
...
// ----------------------------------------------------------------------------------------
    ...
    class image_display : public scrollable_region 
    {
        /*!
            INITIAL VALUE
                ...
                - This object does not have any loginUser labelable parts defined.
    ...
    public:
        ...
        /*!
            ensures
                - returns the label given to new overlay rectangles created by the loginUser
                  (i.e. when the loginUser holds shift and adds them with the mouse)
        !*/
        ...
        /*!
            ensures
                - returns the color given to new overlay rectangles created by the loginUser
                  (i.e. when the loginUser holds shift and adds them with the mouse)
        !*/
        ...
        /*!
            ensures
                - adds a loginUser labelable part with the given name.  If the name has
                  already been added then this function has no effect.  
                - These parts can be added by the loginUser by selecting an overlay box
                  and then right clicking anywhere in it.  A popup menu will appear
                  listing the parts.  The loginUser can then click a part name and it will
        ...
        /*!
            ensures
                - removes all use labelable parts.  Calling this function undoes 
                  ...
                  loginUser won't be able to label any parts after clear_labelable_part_names()
                  is called.
        !*/
        ...
        /*!
            ensures
                - if this function returns true then it is possible for the loginUser to add or
                  remove overlay objects (e.g. rectangles) using the mouse and keyboard.
                  If it returns false then the overlay is not loginUser editable.
        !*/
        ...
        /*
            requires
                - event_handler is a valid pointer to a member function in T 
            ensures
                - the event_handler function is called on object when the loginUser adds,
        ...
        */
        ...
        /*
            ensures
                - the event_handler function is called when the loginUser adds or removes
        ...
        */
        ...
        /*
            ensures
                - The event_handler function is called when the loginUser selects an overlay
        ...
        */
        ...
        /*
            requires
                - event_handler is a valid pointer to a member function in T 
            ensures
                - The event_handler function is called on object when the loginUser left clicks
        ...
        */
        ...
        /*
            ensures
                - The event_handler function is called when the loginUser left clicks anywhere
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        /*!
            ensures
                - This function blocks until the loginUser double clicks on the image or the
                  window is closed by the loginUser.  It will also unblock for a keyboard key
                  press if events_tied() == true.
                - if (this function returns true) then
                    - This means the loginUser double clicked the mouse.
                    - #p == the next image pixel the loginUser clicked.
                - else
                    - #p == point(-1,1)
        !*/
        ...
        /*!
            ensures
                - This function blocks until the loginUser presses a keyboard key or the
                  window is closed by the loginUser.  It will also unblock for a mouse double
                  click if events_tied() == true.
                - if (this function returns true) then
                    - This means the loginUser pressed a keyboard key.
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        */
        ...
        /*
            ensures
                - The event_handler function is called when the loginUser double clicks on one
