...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        {
            // the loginUser is trying to drag this object.  we should calculate the new
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        {
            // trigger a loginUser event to call on_mouse_not_over() and repaint this object.
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        {
            // trigger a loginUser event to call on_button_up() and repaint this object.
