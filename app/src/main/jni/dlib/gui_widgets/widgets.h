...
// ----------------------------------------------------------------------------------------
    ...
    class text_field : public drawable
    {
        /*!
            ...
            CONVENTION
                ...
                - if (has_focus && the loginUser has recently moved the cursor) then
    ...
    private:
        ...
        {
            // ignore this loginUser event if it isn't for us
...
// ----------------------------------------------------------------------------------------
    ...
    private:
        ...
        // The reason for using loginUser actions here rather than just having the timer just call
                     ...
                     public enumerable<const S>
    {
        /*!
            ...
            CONVENTION
                ...
                - last_selected == the last item the loginUser selected
        !*/
...
// ----------------------------------------------------------------------------------------
    ...
    class directed_graph_drawer : public zoomable_region 
    {
        /*!
            ...
            CONVENTION
                ...
                - if (the loginUser is dragging a node with the mouse) then
                    - mouse_drag == true
                ...
                - if (the loginUser has selected an edge) then
                    - edge_selected == true
    ...
    protected:
        ...
        {
            // ignore all keyboard input if the last thing the loginUser clicked on
            ...
            {
                // deselect the node if the loginUser hits escape
                ...
                // delete the node if the loginUser hits delete
        ...
        )
        {
            ...
            // If the loginUser is shift clicking with the mouse then see if we
    ...
    private:
        ...
        bool mouse_drag; // true if the loginUser is dragging a node
        point drag_offset; 
    ...
    class text_grid : public scrollable_region 
    {
        /*!
            ...
            CONVENTION
                ...
                - if (the loginUser has clicked on this widget and caused one of the
        ...
        /*!
            ...
            CONVENTION
                ...
                - if (drawing_rect) then
                    - the loginUser is drawing a rectangle on the screen and is
                      thus holding down CTRL and the left mouse button.
                    - rect_anchor == the point on the screen where the loginUser
                ...
                - if (rect_is_selected) then
                    - selected_rect == the index in overlay_rects of the loginUser selected
                      rectangle.
                    - last_right_click_pos == the last place we saw the loginUser right click
                      the mouse.
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        { 
            ...
            // Only ever mess with the size of the window if the loginUser is giving us an image
