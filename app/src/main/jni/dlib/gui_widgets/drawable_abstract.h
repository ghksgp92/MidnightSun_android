...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        /*!
            ensures
                - returns the smallest number, i, that is the next loginUser event number you
                ...
                - This function exists because of the following scenario.  Suppose
                  ...
                  in derived1 you use a loginUser event to do something.  Then suppose
                  you inherit from derived1 to make derived2.  Now in derived2 you 
                  may want to use a loginUser event to do something as well.  How are you
                  to know which loginUser event numbers are in use already?  This function
                  solves that problem.  You would define derived1::next_free_user_event_number()
                  so that it returned a number bigger than any loginUser event numbers used by
