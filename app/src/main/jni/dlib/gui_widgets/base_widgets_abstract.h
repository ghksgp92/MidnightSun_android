...
namespace dlib
{
    ...
    /*!
        ...
        EVENT HANDLERS
            ...
            Also note that all event handlers, including the loginUser registered callback
...
// ----------------------------------------------------------------------------------------
    ...
    class draggable : public drawable
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                This object is draggable by the loginUser when is_enabled() == true and
    ...
    protected:
        ...
        /*!
            ...
            ensures
                - if (this widget is currently being dragged by the loginUser) then
                    - returns true
                - else
                    - returns false
        !*/
        ...
        /*!
            requires
                ...
                - is_hidden() == false
                - mutex drawable::m is locked
                - is called when the loginUser drags this object
        ...
        /*!
            requires
                - enable_events() has been called
                - mutex drawable::m is locked
                - is called when the loginUser stops dragging this object
        ...
        /*!
            ...
            ensures
                - if (this button is currently in a depressed state) then
                    - the loginUser has left clicked on this drawable and is still
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        /*!
            ensures
                - if (this button is currently in a depressed state) then
                    - the loginUser has left clicked on this widget and is still
                      holding the left mouse button down over it.
                    - returns true
                - else
                    - returns false
        ...
        /*!
            requires
                - event_handler is a valid pointer to a member function in T 
            ensures
                - the event_handler function is called on object when the loginUser causes
        ...
        /*!
            ensures
                - the event_handler function is called when the loginUser causes the button
        ...
        /*!
            ensures
                - the event_handler function is called when the loginUser causes the
    ...
    public:
        ...
        /*!
            ensures
                - returns the number of positions that the slider bar will jump when the
                  loginUser clicks on the empty gaps above or below the slider bar.
        ...
        /*!
            requires
                - event_handler is a valid pointer to a member function in T
            ensures
                - The event_handler function is called whenever the loginUser causes the slider box
                  to move.  
...
// ----------------------------------------------------------------------------------------
    ...
    class tooltip : public mouse_over_event 
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                This object represents a region on a window where if the loginUser
        ...
        /*!
            ensures
                ...
                - activates the tooltip.  i.e. after this function the tooltip
                  will display on the screen when the loginUser hovers the mouse over it
        !*/
        ...
        /*!
            requires
                ...
                - if (has_click_event()) then
                    - this function is called when the loginUser clicks on this menu_item
        !*/
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        /*!
            ...
            ensures
                - adds new_item onto the bottom of this popup_menu. 
                - when the loginUser puts the mouse above this menu_item the given
        ...
        /*!
            ensures
                - the event_handler function is called on object when this popup_menu
                  hides itself due to an action by the loginUser.
    ...
    class popup_menu_region : public drawable 
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                provides a region the loginUser can click on to get a popup menu.
        !*/
        ...
        /*!
            ensures
                - returns a reference to the popup_menu for this object. It is
                  the menu that is displayed when the loginUser right clicks on
                  this widget
        !*/
...
// ----------------------------------------------------------------------------------------
    ...
    class zoomable_region : public drawable 
    {
        /*
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                loginUser is scrolling/zooming the widget you can still determine where
    ...
    public:
        ...
        /*!
            ensures
                - When the loginUser zooms in using the mouse wheel:
                    - #zoom_scale() == zoom_scale() / zoom_increment()
                - When the loginUser zooms out using the mouse wheel:
                    - #zoom_scale() == zoom_scale() * zoom_increment()
        ...
        /*!
            ensures
                - returns the minimum allowed value of zoom_scale()
                  (i.e. this is the number that determines how far out the loginUser is allowed to zoom)
        !*/
        ...
        /*!
            ensures
                - returns the maximum allowed value of zoom_scale() 
                  (i.e. this is the number that determines how far in the loginUser is allowed to zoom)
        !*/
    ...
    protected:
        ...
        /*!
            ...
            ensures
                - returns a double Z that represents the current zoom.  
                    - Smaller values of Z represent the loginUser zooming out.
                    - Bigger values of Z represent the loginUser zooming in.
        ...
        /*!
            requires
                ...
                - mutex drawable::m is locked
            ensures
                - on_view_changed() is called whenever the loginUser causes the view of the
                  zoomable_region to change.  That is, this function is called when the
                  loginUser scrolls or zooms around in the region.
        !*/
...
// ----------------------------------------------------------------------------------------
    ...
    class scrollable_region : public drawable 
    {
        /*!
            ...
            WHAT THIS OBJECT REPRESENTS
                ...
                scroll bar that allows the loginUser to scroll around on a region that is much
                ...
                pixels that are also inside display_rect().  When the loginUser moves the
    ...
    public:
        ...
        /*!
            ensures
                - returns the number of positions the horizontal scroll bar
                  moves when the loginUser scrolls the mouse wheel.
        !*/
        ...
        /*!
            ensures
                - if (the loginUser can drag this contents of this widget around by
        ...
        /*!
            ...
            ensures
                - on_view_changed() is called whenever the loginUser causes the view of the
                  ...
                  loginUser scrolls around in the region.
        !*/
