...
// ----------------------------------------------------------------------------------------
    ...
    class draggable : public drawable
    {
        /*!
            ...
            CONVENTION
                - if (the loginUser is holding the left button down over this object) then
                    - drag == true
    ...
    class button_action : public mouse_over_event 
    {
        /*!
            ...
            CONVENTION
                ...
                - if (the loginUser has clicked the button but hasn't yet released the
...
// ----------------------------------------------------------------------------------------
    ...
    private:
        ...
        )
        {
            ...
            // keep waiting until the loginUser stops moving it
...
// ----------------------------------------------------------------------------------------
    ...
    private:
        ...
        /*!
            requires
                - is called whenever the loginUser drags the slider
        !*/
...
// ----------------------------------------------------------------------------------------
    ...
    class zoomable_region : public drawable 
    {
        /*!
            ...
            CONVENTION
                ...
                - zoom_scale() == scale
                - if (the loginUser is currently dragging the graph around via the mouse) then
    ...
    private:
        ...
        bool mouse_drag_screen;  // true if the loginUser is dragging the white background area
    ...
    class scrollable_region : public drawable 
    {
        /*!
            ...
            CONVENTION
                ...
                - if (the loginUser is currently dragging the total_rect around with a mouse drag) then
