...
// ----------------------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------------------
        ...
        {
            // The point of this extra event_handler stuff is to allow the loginUser
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        if (has_focus)
        {
            if (is_printable)
            {
                // if the loginUser hit the tab key then jump to the next box
                if (key == '\t')
                {
                ...
                {
                    // insert the key the loginUser pressed into the string
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // disable mouse wheel if the loginUser is drawing a rectangle
        if (drawing_rect)
            return;
