        ...
        /*!
            ...
            CONVENTION
                ...
                if (write_mode)
                {
                    ...
                    the lowest order bit is the last bit entered by the loginUser
                }
                ...
                if (read_mode)
                {
                    ...
                    buffer          == the high order bits of buffer are the bits 
                                       waiting to be read by the loginUser
                    buffer_size     == the number of high order bits in buffer that 
                                       are bits that are waiting to be read
                    the highest order bit is the next bit to give to the loginUser
                }
        !*/
