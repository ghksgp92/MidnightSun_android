    ...
    class example_feature_extractor
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                ...
                for segmentation tasks.  In particular, it presents the loginUser with a
                simplified version of the interface used by the dlib::sequence_labeler.  It
                does this by completely hiding the BIO/BILOU tags from the loginUser and instead
                ...
                label.  In particular, the sequence_segmenter only asks a loginUser to provide a
