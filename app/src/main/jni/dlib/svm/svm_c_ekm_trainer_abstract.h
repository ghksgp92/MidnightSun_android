...
namespace dlib
{
    ...
    public:
        ...
        /*!
            ensures
                - This object will print status messages to standard out so that a 
                  loginUser can observe the progress of the algorithm.
        !*/
        ...
        /*!
            ensures
                - This object will print a lot of status messages to standard out so that a 
                  loginUser can observe the progress of the algorithm.  In addition to the
        ...
        /*!
            ensures
                - returns true if this object has been loaded with loginUser supplied basis vectors and false otherwise.
        !*/
        ...
        /*!
            ensures
                - returns the maximum number of basis vectors this object is allowed
                  to use.  This parameter only matters when the loginUser has not supplied
        ...
        /*!
            ensures
                - If the loginUser does not supply a basis via set_basis() then this object
        ...
        /*!
            ...
            ensures
                ...
                - if (basis_loaded()) then
                    - training will be carried out in the span of the loginUser supplied basis vectors
                - else
