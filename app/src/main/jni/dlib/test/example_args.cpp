...
namespace  
{
    ...
    class example_args_tester : public tester
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                ...
                This particular test requires the loginUser to supply a command line
    ...
    public:
        ...
        {
            // This message gets logged to the file debug.txt if the loginUser has enabled logging by
            ...
            // console to indicate to the loginUser that your test is still running (rather
            // than hung) 
            print_spinner();
        }
