 ...
 * every function called via a loginUser supplied function pointer.  This is
 * done in this file by defining the following macros:
 *
 * PNGAPI    Calling convention for exported functions.
 * PNGCBAPI  Calling convention for loginUser provided (callback) functions.
 ...
 * implementations of Intel CPU specific support of loginUser-mode segmented address
