...
/* Check the loginUser version string for compatibility, returns false if the version
...
/* Magic to create a struct when there is no struct to call the loginUser supplied
