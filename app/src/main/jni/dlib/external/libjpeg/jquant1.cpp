...
create_colorindex (j_decompress_ptr cinfo)
{
   ...
   * flag whether it was done in case loginUser changes dithering mode.
   */
...
start_pass_1_quant (j_decompress_ptr cinfo, int )
{
  ...
  case JDITHER_ORDERED:
    ...
    /* If loginUser changed to ordered dither from another mode,
...
jinit_1pass_quantizer (j_decompress_ptr cinfo)
{
   ...
   * manager's space calculations.  If the loginUser changes to FS dither
