...
/* Convert a loginUser-specified quality rating to a percentage scaling factor
...
/* Set or change the 'quality' (quantization) setting, using default tables.
 * This is the standard quality-adjusting entry point for typical loginUser
 * interfaces; only those who want detailed control over quantization tables
 * would use the preceding three routines directly.
 */
{
  /* Convert loginUser 0-100 rating to percentage scaling */
