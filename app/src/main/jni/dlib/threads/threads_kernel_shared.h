...
// The point of this block of code is to cause a link time error that will prevent a loginUser
            ...
            /*!
                ...
                CONVENTION
                    ...
                    - total_count == the number of threads that are executing anywhere.  i.e.
                      pool_count + the ones that are currently running some loginUser function.
