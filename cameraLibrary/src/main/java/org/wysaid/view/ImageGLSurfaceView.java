...
public class ImageGLSurfaceView extends GLSurfaceView implements Renderer {
    ...
    /**
     * 이미지에 필터 설정 후 바로 이미지로 저장할 수 있도록 한다.
     * @param config
     * @param callback
     */
    public void setFilterWithConfig(final String config, final ImageGLSurfaceView.QueryResultBitmapCallback callback) {
